<?php
    ...
    if(mysqli_affected_rows($conn)){
        ...
        $_SESSION['msg'] = "<div id='aviso'><p class='p-2 mb-2 text-center bg-danger text-white mr-2'>Erro ao atualizar o usuário.</p><button class='btn btn-danger btn-sm' onClick='$function'>X</button></p></div>";
