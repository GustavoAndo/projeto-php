...
<body>
    ...
    ?>
            <tr>
                ...
                <td> 
                    <a href="./redefinicao-senha.php?matricula=<?php echo $row['usu_matricula'] ?>">Nova Senha</td>
                </td>
                <td>
                    <a href="./edicao.php?matricula=<?php echo $row['usu_matricula'] ?>">Editar</a>
                </td>
                <td>
                    <a href="javascript: if(confirm('Tem certeza que deseja deletar o usuário <?php echo $row['usu_nome'] ?>?')) 
                    location.href='../../services/usuario/excluir.php?matricula=<?php echo $row['usu_matricula'] ?>';">Excluir</a>
                </td>
            </tr>       
    <?php
