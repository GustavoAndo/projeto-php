    ...
    ?>
        ...
        ?>
                <tr>
                    ...
                    ?></td>
                    <td>
                        <a class="btn btn-primary btn-sm " href="./edicao.php?matricula=<?php echo $row['pro_id'] ?>">Editar</a>
                    </td>
                    <td>
                        ...
                        <div class="modal-dialog" role="document">
                            ...
                            <div class="modal-footer">
                                ...
                                <a href="../../services/projeto/excluir.php?matricula=<?php echo $row['pro_id']?>" class="btn btn-danger">Excluir</a>
                            </div>
                            </div>
                        </div>
                        </div>
